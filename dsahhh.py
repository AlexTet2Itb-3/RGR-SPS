...
def update_charts(selected_date):
    ...
    # Круговая диаграмма
    pie_chart = px.pie(filtered_df, names='Время изменения', values='Количество солнечной радиации (в Ваттах/квадратный метр)',
                       title='Круговая диаграмма')

    # Ящик с усами
    box_plot = px.box(filtered_df, x='Время изменения', y='Количество солнечной радиации (в Ваттах/квадратный метр)',
                      title='Ящик с усами')

    # Точечный график
    scatter_plot = px.scatter(filtered_df, x='Время изменения', y='Количество солнечной радиации (в Ваттах/квадратный метр)',
